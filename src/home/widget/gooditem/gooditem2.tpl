    ...
    <a class="gooditem {%$cls%}" href="/car/{%$list.id%}.html" target="_blank">
        ...
        <div class="good-floor">
            ...
            <p class="coupon">
                ...
                <span class="miao-price">一猫价:{%$list.minPrice|format_price%}{%if $list.multiple>1%}起{%/if%}</span>
                {%/if%}
            </p>
            <p class="chang-mao-price">
                ...
                {%/if%}
                <span class="chang-price">指导价：{%$list.price%}万{%if $list.multiple>1%}起{%/if%}</span>
            </p>
