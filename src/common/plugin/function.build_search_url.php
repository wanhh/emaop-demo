...
{
    $DEFAULT_ACTION=explode("?",$_SERVER['REQUEST_URI'])[0];
    static $DEFAULT_INCLUDE=array('ie');
    //除这些参数以外，其他均不透传
    $all_params=array( 'wd', 'cl', 'ct', 'tn', 'rn', 'ie', 'lm', 'si', 'usm', 'z', 'ch', 'sts', 'vit', 'dsp', 'trh', 'trb', 'tre','la','lo','st','nojc','haobd','rtt','bsst','gvideo');
